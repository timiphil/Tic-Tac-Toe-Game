...
function checkwin() {
   ...
   return (
    xo[0] == xo[1] && xo[1] == xo[2] && helper(0, 1, 2)) || (xo[3] == xo[4] && xo[4] == xo[5] && helper(3, 4, 5)) || (xo[6] == xo[7] && xo[7]  == xo[8] && helper(6, 7, 8)) || (xo[0] == xo[3] && xo[3] == xo[6] && helper(0, 3, 6)) || (xo[1] == xo[4] && xo[4] == xo[7] && helper(1, 4, 7)) || (xo[2] == xo[5] && xo[5] == xo[8] && helper(2, 5, 8)) || (xo[0] == xo[4] && xo[4] == xo[8] && helper(0, 4, 8)) || (xo[2] == xo[4] && xo[4] == xo[6] && helper(2, 4, 6)
  )
}
...
function helper2(arr, index1, index2, index3){
  return arr[index1] != "" && arr[index2] != "" && arr[index3]!= "" && arr[index1] == humanicon;
}
...
if (
  (boards[0]==boards[1] && boards[1] ==boards[2] && helper1(boards,0,1,2)) || (boards[3]==boards[4] && boards[4] ==boards[5] && helper1(boards,3,4,5)) || (boards[6]==boards[7] && boards[7] ==xo[8] && helper1(boards,6,7,8)) || (boards[0]==boards[3] && boards[3] ==boards[6] && helper1(boards,0,3,6)) || (boards[1]==boards[4] && boards[4] ==boards[7] && helper1(boards,1,4,7)) || (boards[2]==boards[5] && boards[5] ==boards[8] && helper1(boards,2,5,8)) ||  (boards[0]==boards[4] && boards[4] ==boards[8] && helper1(boards,0,4,8)) ||  (boards[2]==boards[4] && boards[4] ==boards[6] && helper1(boards,2,4,6))
  ) {
    return "aiwin";
  } else if (  
  ((boards[0]==boards[1] && boards[1] ==boards[2] && helper2(boards,0,1,2)) || (boards[3]==boards[4] && boards[4] ==boards[5] && helper2(boards,3,4,5)) || (boards[6]==boards[7] && boards[7] ==xo[8] && helper2(boards,6,7,8)) || (boards[0]==boards[3] && boards[3] ==boards[6] && helper2(boards,0,3,6)) || (boards[1]==boards[4] && boards[4] ==boards[7] && helper2(boards,1,4,7)) || (boards[2]==boards[5] && boards[5] ==boards[8] && helper2(boards,2,5,8)) ||  (boards[0]==boards[4] && boards[4] ==boards[8] && helper2(boards,0,4,8)) ||  (boards[2]==boards[4] && boards[4] ==boards[6] && helper2(boards,2,4,6)))
  ) {
    return "humanwin"
  }
else if (boardfull()) {
